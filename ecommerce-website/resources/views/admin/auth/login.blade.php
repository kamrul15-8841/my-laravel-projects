            ...
            <div class="card-body">
                ...
                <form action="{{route('login')}}" method="POST">
                    ...
                    <div class="mb-0 d-grid text-center">
                        <button class="btn btn-primary" type="submit"><i class="mdi mdi-account-circle"></i> Login </button>
                    </div>
                    <!-- social-->
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">Already have account? <a href="{{route('register')}}" class="text-muted ms-1"><b>Registration</b></a></p>
                </footer>
